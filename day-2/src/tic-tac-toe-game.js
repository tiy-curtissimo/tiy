...
class TicTacToeGame {
  ...
  static fromPojo(pojo) {
    const game = new this({humanFirst: true})
    game.board._state = pojo.boardState
    game.humanFirst = pojo.humanFirst
    return game
  }

  static fromJson(json) {
    return this.prototype.constructor.fromPojo(JSON.parse(json))
  }
